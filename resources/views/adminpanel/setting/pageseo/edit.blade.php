...
@section('content')
    <div class="box-heading">
        <div class="box-heading-left">
            <div class="box-title">
                <h4 class="neutral-1000 mb-15">SEO</h4>
            </div>
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        <li> <a class="icon-home" href="{{ route('admin.index') }}">Dashboard</a></li>
                        <li><a class="icon-home" href="{{ route('setting.index') }}">Settings</a></li>
    ...
    <div class="section-box">
        <div class="">
            <div class="row">
                <form method="post" action="{{ route('setting.update', $meta->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="box-form-add">
                        <h5 class="neutral-1000 mb-12">General Form</h5>
                        <div class="box-border-bottom">
                            <div class="row">
                                <!-- Content Field -->
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <textarea class="form-control" name="description" rows="6" id="editor1">{{ $meta->description }}</textarea>
                                    </div>
                                </div>
                                @if (!empty($meta->qna) && count($meta->qna) > 0)
                                    <div class="col-lg-12 mb-3">
                                        <p class="text-md-bold neutral-1000 mb-12">Question & Answer</p>
                                        <div class="box-extra-services2" id="faq2">
                                            @foreach ($meta->qna as $qna)
                                                    ...
                                                    <div class="image-preview" id="imagePreview_{{ $image->id }}">
                                                        <div class="box-image-preview position-relative">
                                                            ...
                                                            <a class="remove-link btn-delete-image" href="#"
                                                                onclick="event.preventDefault(); deleteTourImage({{ $meta->id }}, {{ $image->id }})">
                        ...
                        <div class="box-button-save">
                            <button type="submit" name="published" class="btn btn-black">Save</button>
                        </div>
                    </div>
    ...
    <script>
        function deleteTourImage(Pageid, imageId) {
            const url = `/admin/setting/${Pageid}/image/${imageId}`;
