            ...
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        ...
                        <li><span>Vehicle post list</span></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="box-heading-right"> <a class="btn btn-brand-secondary" href="{{ route('vehicle.create') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="card-tour">
                                        ...
                                        <a class="text-md-bold neutral-1000" href="#">{{ $post->title }}</a>
                                    </div>
                                </td>
                                <td>
                                    <span class="text-md-medium neutral-500">{{ $post->created_at }}</span>
                                </td>
                                <td class="text-center">
                                    <a class="btn btn-primary" href="{{ route('rentals.show', $post->slug) }}"
                                        style="padding: 2px 5px; font-size: 12px;">View</a>
                                    <a class="btn btn-secondary" href="{{ route('vehicle.edit', $post->id) }} "
                                        style="padding: 2px 5px; font-size: 12px;">Edit</a>
                                    <form action="{{ route('vehicle.destroy', $post->id) }}" method="POST"
    ...
    @if ($posts->hasPages())
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{ $posts->previousPageUrl() }}" aria-label="@lang('pagination.previous')">
                ...
                @if ($posts->hasMorePages())
                    <li class="page-item">
                        <a class="page-link" href="{{ $posts->nextPageUrl() }}" aria-label="@lang('pagination.next')">
                            <span aria-hidden="true">
                                <svg width="12" height="12" viewbox="0 0 12 12" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
