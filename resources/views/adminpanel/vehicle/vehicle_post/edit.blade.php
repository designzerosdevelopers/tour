...
@section('content')
    ...
    <div class="box-heading">
        <div class="box-heading-left">
            <div class="box-title">
                <h4 class="neutral-1000 mb-15">Vehicle Post</h4>
            </div>
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        <li><a class="icon-home" href="{{ route('admin.index') }}">Dashboard</a></li>
                        <li><a class="icon-home" href="{{ route('vehicle.index') }}">Vehicle Post List</a></li>
    ...
    <div class="section-box">
        <div class="">
            <div class="row">
                <form method="post" action="{{ route('vehicle.update', $vehicle_post->id) }}"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-lg-12">
                        <div class="box-form-add">
                            <h5 class="neutral-1000 mb-12">Vehicle post Form</h5>
                            <div class="box-border-bottom">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="title" name="title"
                                                placeholder="Title" value="{{ $vehicle_post->title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="status" name="status"
                                                placeholder="Status" value="{{ $vehicle_post->status }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control" type="number" id="price" name="price"
                                                placeholder="Price" value="{{ $vehicle_post->price }}">
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control" id="vehicle_id" name="vehicle_id">
                                                ...
                                                @foreach ($vehicle_list as $vehicle)
                                                    <option value="{{ $vehicle->id }}"
                                                        {{ $vehicle_post->vehicle_id == $vehicle->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="location" name="location"
                                                placeholder="Location" value="{{ $vehicle_post->location }}">
                                        </div>
                                    </div>

                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea class="form-control" rows="8" id="description" name="description" placeholder="Description">{{ $vehicle_post->description }}</textarea>
                                        </div>
                                    </div>

                                    @if (!empty($vehicle_post->more_fields['qna']) && count($vehicle_post->more_fields['qna']) > 0)
                                        <div class="col-lg-12 mb-3">
                                            <p class="text-md-bold neutral-1000 mb-12">Question & Answer</p>
                                            <div class="box-extra-services2" id="faq2">
                                                @foreach ($vehicle_post->more_fields['qna'] as $qna)
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <p class="text-md-bold neutral-1000 mb-12">Included in the price</p>
                                        <div class="box-extra-services">
                                            @if (!empty($vehicle_post->more_fields['values']) && count($vehicle_post->more_fields['values']) > 0)
                                                @foreach ($vehicle_post->more_fields['values'] as $value)
                                            ...
                                            @endif
                                        </div><a class="btn btn-dark btn-addmore2" href="#">Add More</a>
                                    </div>
                                        ...
                                        <div class="list-image-upload">
                                            ...
                                            <div class="preview-images">
                                                <div class="list-preview" id="imagePreviewContainer">
                                                    @foreach ($vehicle_post->images as $image)
                                                        <div class="image-preview" id="imagePreview_{{ $image->id }}">
                                                            <div class="box-image-preview position-relative">
                                                                ...
                                                                <a class="remove-link btn-delete-image" href="#"
                                                                    onclick="event.preventDefault(); deleteVehicleImage({{ $vehicle_post->id }}, {{ $image->id }})">
    ...
    <script>
        function deleteVehicleImage(vehiclePostId, imageId) {
            const url = `/admin/vehicle/${vehiclePostId}/image/${imageId}`;
