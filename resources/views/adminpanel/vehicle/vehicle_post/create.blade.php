            ...
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        ...
                        <li><span>Add vehicle post</span></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="box-form-add">
                            ...
                            <div class="box-border-bottom">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea class="form-control" rows="8" id="description" name="description" placeholder="Description">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="box-button-save">
                                <button type="submit" name="published" value="1"
                                    class="btn btn-black">Publish</button>
                            </div>
                        </div>
                    </div>
