...
@section('content')
                ...
                <div class="row">
                            ...
                            <div class="box-border-bottom">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="title"
                                                value="{{ old('title', $tour->title) }}" placeholder="Tour Name">
                                            @if ($errors->has('title'))
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="description" rows="6" id="editor1">{{ old('description', $tour->description) }}</textarea>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="duration"
                                                value="{{ old('duration', $tour->duration) }}" placeholder="i.e 2-3 hours">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="tour_type" class="form-control">
                                                <option value="Half Day" {{ $tour->tour_type === 'Half Day' ? 'selected' : '' }}>Half Day</option>
                                                <option value="Full Day" {{ $tour->tour_type === 'Full Day' ? 'selected' : '' }}>Full Day</option>
                                            </select>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="adult_price"
                                                value="{{ $tour->adult_price }}" placeholder="Price">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="child_price"
                                                value="{{ $tour->child_price }}" placeholder="Price">
                                                        ...
                                                        <div class="image-preview" id="imagePreview_{{ $image->id }}">
                                                            <div class="box-image-preview position-relative">
                                                                ...
                                                                <a class="remove-link btn-delete-image" href="#"
                                                                    onclick="event.preventDefault(); deleteTourImage({{ $tour->id }}, {{ $image->id }})">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="box-form-add">
                            ...
                            <div class="row">
                                @php
                                    // Decode the public tour timings into an array
                                    $availableTimings = json_decode($tour->public_tour_timings);
                                @endphp
                            
                                @foreach ($tourTimes as $tourTime)
                                    <div class="col-lg-3">
                                        <label class="lbl-checkbox text-md-medium neutral-500">
                                            <input type="checkbox" name="public_tour_timings[]" value="{{ $tourTime }}"
                                                @if (is_array($availableTimings) && in_array($tourTime, $availableTimings)) checked @endif>
                                            {{ $tourTime }}
                                        </label>
                                    </div>
                                @endforeach
                                ...
                                @if ($errors->has('public_tour_timings'))
                                    <div class="text-danger">{{ $errors->first('public_tour_timings') }}</div>
                                @endif
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="box-button-save mt-15">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="other_info" rows="6" id="editor2"> {{ old('other_info', $tour->other_info) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="attraction_id" name="attraction_id">
                                        <option value="0" {{ $tour->attraction_id == 0 ? 'selected' : '' }}>No
                                            Attraction</option>
                                        @foreach ($attractions_list as $attraction)
                                            <option value="{{ $attraction->id }}"
                                                {{ $tour->attraction_id == $attraction->id ? 'selected' : '' }}>
                                                {{ $attraction->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="destination_id" name="destination_id">
                                        <option value="0" {{ $tour->destination_id == 0 ? 'selected' : '' }}>No
                                            Destination</option>
    ...
    <script>
        function deleteTourImage(attractionPostId, imageId) {
            const url = `/admin/tour/${attractionPostId}/image/${imageId}`;
