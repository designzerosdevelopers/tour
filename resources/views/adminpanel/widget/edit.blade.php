...
@section('content')
    <div class="box-heading">
        <div class="box-heading-left">
            <div class="box-title">
                <h4 class="neutral-1000 mb-15">Widget</h4>
            </div>
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        <li><a class="icon-home" href="{{ route('admin.index') }}">Dashboard</a></li>
                        <li><a class="icon-home" href="{{ route('widget.index') }}">Widgets</a></li>
                        <li><span>Add tour widget</span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="section-box">
        <div class="">
            <div class="row">
                <form method="post" action="{{ route('widget.update', $widgets[0]['tour_id']) }}"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-lg-12">
                        <div class="box-form-add">
                            <h5 class="neutral-1000 mb-12">Widget Form</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="">
                                                    <div class="box-upload-image">
                                                        <div class="item-upload-image" id="upload-image-1"
                                            ...
                                            <div class="col-6">
                                                <div class="preview-images">
                                                    <div class="list-preview" id="imagePreviewContainer1">
                                                        <div class="image-preview">
                                                            <div class="box-image-preview position-relative">
                                                                <input type="hidden" name="images[]" value="{{$widgets[0]->image->id }}">
                                                                <img src="{{ asset($widgets[0]->image->path . $widgets[0]->image->file) }}"
                                                                    alt="" class="img-fluid my-1">
                                    ...
                                    <div class="col-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="title[]"
                                                placeholder="write title" value="{{ $widgets[0]['title'] }}" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" name="description[]" placeholder="write description" rows="4" required>{{ $widgets[0]['description'] }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="">
                                                    <div class="box-upload-image">
                                                        <div class="item-upload-image" id="upload-image-2"
                                                            style="cursor: pointer">
                                                            <div class="upload-info">
                                                                <div class="icon-upload">
                                                                    <svg width="22" height="23" viewBox="0 0 22 23"
                                            ...
                                            <div class="col-6">
                                                <div class="preview-images">
                                                    <div class="list-preview" id="imagePreviewContainer2">
                                                        <div class="image-preview">
                                                            <div class="box-image-preview position-relative">
                                                                <input type="hidden" name="images[]" value="{{$widgets[1]->image->id }}">
                                                                <img src="{{ asset($widgets[1]->image->path.$widgets[1]->image->file) }}"
                                                                    alt="" class="img-fluid my-1">
                                                                <a class="remove-link btn-delete-image" href="#">
                                    ...
                                    <div class="col-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="title[]"
                                                placeholder="write title" value="{{ $widgets[1]['title'] }}" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" name="description[]" placeholder="write description" rows="4" required>{{ $widgets[1]['description'] }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="">
                                                    <div class="box-upload-image">
                                                        <div class="item-upload-image" id="upload-image-3"
                                                            style="cursor: pointer">
                                                            <div class="upload-info">
                                                                <div class="icon-upload">
                                            ...
                                            <div class="col-6">
                                                <div class="preview-images">
                                                    <div class="list-preview" id="imagePreviewContainer3">
                                                        <div class="image-preview">
                                                            <div class="box-image-preview position-relative">
                                                                <input type="hidden" name="images[]" value="{{$widgets[2]->image->id }}">
                                                                <img src="{{ asset($widgets[2]->image->path . $widgets[2]->image->file) }}"
                                                                    alt="" class="img-fluid my-1">
                                                                <a class="remove-link btn-delete-image" href="#">
                                                                    <svg width="16" height="16"
                                                                        viewBox="0 0 16 16" fill="none"
                                    ...
                                    <div class="col-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="title[]"
                                                placeholder="write title" value="{{ $widgets[2]['title'] }}" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" name="description[]" placeholder="write description" rows="4" required>{{ $widgets[2]['description'] }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="">
                                                    <div class="box-upload-image">
                                                        <div class="item-upload-image" id="upload-image-4"
                                                            style="cursor: pointer">
                                                            <div class="upload-info">
                                                                <div class="icon-upload">
                                                                    <svg width="22" height="23"
                                            ...
                                            <div class="col-6">
                                                <div class="preview-images">
                                                    <div class="list-preview" id="imagePreviewContainer4">
                                                        <div class="image-preview">
                                                            <div class="box-image-preview position-relative">
                                                                <input type="hidden" name="images[]" value="{{$widgets[3]->image->id }}">
                                                                <img src="{{ asset($widgets[3]->image->path . $widgets[3]->image->file) }}"
                                                                    alt="" class="img-fluid my-1">
                                                                <a class="remove-link btn-delete-image" href="#">
                                                                    <svg width="16" height="16"
                                                                        viewBox="0 0 16 16" fill="none"
                                    ...
                                    <div class="col-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="title[]"
                                                placeholder="write title" value="{{ $widgets[3]['title'] }}" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" name="description[]" placeholder="write description" rows="4" required>{{ $widgets[3]['description'] }}</textarea>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body">
                    @include('adminpanel.media.widgetMediabox')
                </div>
            </div>
        </div>
    </div>
