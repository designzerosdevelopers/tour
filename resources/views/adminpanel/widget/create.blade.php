...
@section('content')
    ...
    <div class="section-box">
        <div class="">
            <div class="row">
                <form method="post" action="{{ route('widget.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-lg-12">
                        <div class="box-form-add">
                            ...
                            <div class="box-border-bottom">
                                    ...
                                    <div class="col-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="title[]"
                                                placeholder="write title" value="{{ old('title') }}" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" name="description[]" placeholder="write description" rows="4" required>{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="form-group mt-3">
                                    <label class="text-md-medium neutral-500">Add widget in tour</label>
                                    ...
                                    @if ($errors->has('tour_id'))
                                        <div class="error">{{ $errors->first('tour_id') }}</div>
                                    @endif
                                </div>
                            </div>
