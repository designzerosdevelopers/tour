...
@section('content')
    <div class="box-heading">
        <div class="box-heading-left">
            <div class="box-title">
                <h4 class="neutral-1000 mb-15">Attraction</h4>
            </div>
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        <li><a class="icon-home" href="{{route('admin.index')}}">Dashboard</a></li>
                        <li><a class="icon-home" href="{{route('attraction.index')}}">Attractions</a></li>
                        <li><span>Edit attraction</span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="section-box">
        <div class="">
            <div class="row">
                <form method="post" action="{{ route('attraction.update', $attraction->id) }}"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-lg-12">
                        <div class="box-form-add">
                            <h5 class="neutral-1000 mb-12">Attraction Form</h5>
                            ...
                            <div class="box-border-bottom">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="title"
                                                value="{{ $attraction->title }}" placeholder="Title"
                                                value="{{ old('title') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="status"
                                                value="{{ $attraction->status }}" placeholder="status">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea class="form-control bg-dark" name="description" rows="6" id="editor1">{{ $attraction->description }}</textarea>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="image-preview" id="imagePreview_{{ $image->id }}">
                                                            <div class="box-image-preview position-relative">
                                                                ...
                                                                <a class="remove-link btn-delete-image" href="#"
                                                                    onclick="event.preventDefault(); deleteAttractionImage({{ $attraction->id }}, {{ $image->id }})">
                            ...
                            <div class="box-button-save">
                                <button type="submit" name="published" value="1" class="btn btn-black">Update</button>
                                <button type="submit" name="published" value="0" class="btn btn-black">Draft</button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function deleteAttractionImage(attractionId, imageId) {
            const url = `/admin/attraction/${attractionId}/image/${imageId}`;
