            ...
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        ...
                        <li><span>Activities list</span></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="box-heading-right"> <a class="btn btn-brand-secondary" href="{{ route('activity.create') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="card-activity">
                                        ...
                                        <a class="text-md-bold neutral-1000" href="#">{{ $activity->title }}</a>
                                    </div>
                                </td>
                                <td>
                                    <span class="text-md-medium neutral-500">{{ $activity->created_at }}</span>
                                </td>
                                <td class="text-center">
                                    <a class="btn btn-primary" href="{{ route('activities.show', $activity->slug) }}"
                                        style="padding: 2px 5px; font-size: 12px;">View</a>
                                    <a class="btn btn-secondary" href="{{ route('activity.edit', $activity->id) }} "
    ...
    @if ($activities->hasPages())
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{ $activities->previousPageUrl() }}" aria-label="@lang('pagination.previous')">
                ...
                {{-- Pagination Elements --}}
                @foreach ($activities->links()->elements as $element)
                ...
                @if ($activities->hasMorePages())
                    <li class="page-item">
                        <a class="page-link" href="{{ $activities->nextPageUrl() }}" aria-label="@lang('pagination.next')">
                            <span aria-hidden="true">
                                <svg width="12" height="12" viewbox="0 0 12 12" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
