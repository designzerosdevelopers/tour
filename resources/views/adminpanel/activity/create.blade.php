                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="box-form-add">
                            <h5 class="neutral-1000 mb-12">General</h5>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="title"
                                                value="{{ old('title') }}" placeholder="activity Name">
                                            @if ($errors->has('title'))
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            @if ($errors->has('private_transport_extra_cost'))
                                                <div class="error">{{ $errors->first('private_transport_extra_cost') }}
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                  ...
                  <div class="row"> 
                    ...
                    <div class="col-lg-5">
                        <div class="box-form-add">
                            ...
                            <h5 class="neutral-1000 mb-12">Select time for public activitys </h5>
                            <div class="row">
                                @foreach ($activityTimes as $activityTime)
                                    <div class="col-lg-3">
                                        <label class="lbl-checkbox text-md-medium neutral-500">
                                            <input type="checkbox" name="public_activity_timings[]"
                                                value="{{ $activityTime }}"> {{ $activityTime }}
                                        </label>
                                    </div>
                                @endforeach
                  ...
                  <button class="btn btn-gray">Save Changes</button>
                            ...
                            <div class="form-group">
                                ...
                                @if ($errors->has('attraction_id'))
                                    <div class="error">{{ $errors->first('attraction_id') }}</div>
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if ($errors->has('destination_id'))
                                    <div class="error">{{ $errors->first('destination_id') }}</div>
                                @endif
                            </div>
