            ...
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        ...
                        <li><span>Edit Desitnation</span></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <form method="post" action="{{ route('destination.update', $destination->id) }}"
                    ...
                    <div class="col-lg-12">
                        <div class="box-form-add">
                            <h5 class="neutral-1000 mb-12">Edit destination</h5>
                            <div class="box-border-bottom">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="title" name="title"
                                                placeholder="Title" value="{{ $destination->title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea class="form-control" rows="8" id="editor1" name="description" placeholder="Description">{{ $destination->description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    @if (!empty($destination->qna) && count($destination->qna) > 0)
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <div class="box-extra-services2" id="faq2">
                                                @foreach ($destination->qna as $qna)
                                                ...
                                                <div class="preview-images">
                                                    <div class="list-preview" id="imagePreviewContainer">
                                                        <div class="image-preview"
                                                            id="imagePreview_{{ $destination->image->id }}">
                                                            <div class="box-image-preview position-relative">
                                                                <img src="{{ asset($destination->image->path . $destination->image->file) }}"
                            ...
                            <div class="box-button-save">
                                <button type="submit" class="btn btn-black">Update Destination</button>
                            </div>
                        </div>
