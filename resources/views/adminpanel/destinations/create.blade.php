...
@section('content')
    <div class="box-heading">
        <div class="box-heading-left">
            <div class="box-title">
                <h4 class="neutral-1000 mb-15">Desitnation</h4>
            </div>
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        <li> <a class="icon-home" href="{{route('admin.index')}}">Dashboard</a></li>
                        <li><a class="icon-home" href="{{route('destination.index')}}">Destinations</a></li>
                        <li><span>Add New Desitnation</span></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <form method="post" action="{{ route('destination.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12">
                        <div class="box-form-add">
                            <h5 class="neutral-1000 mb-12">Create tour desitnation</h5>
                            <div class="box-border-bottom">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control" type="text" id="title" name="title"
                                                placeholder="Destination Title" value="{{ old('title') }}">
                                        </div>
                                    </div>

                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            {{-- <input class="form-control" type="text" id="destination_status" name="destination_status"
                                                placeholder="Active/Inactive" value="{{ old('destination_status') }}"> --}}
                                            Active <input type="radio" name="status" value="1">
                                            in Active <input type="radio" name="status" value="0">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea class="form-control" rows="8" id="editor1" name="description" placeholder="Description">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="box-button-save">
                                <button type="submit" name="Submit" value="1" class="btn btn-black">Add
                                    Destination </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body">
                    @include('adminpanel.media.select1Mediabox')
                </div>
            </div>
        </div>
    </div>
