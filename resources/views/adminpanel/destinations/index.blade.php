...
@section('content')
    <div class="box-heading">
        <div class="box-heading-left">
            <div class="box-title">
                <h4 class="neutral-1000 mb-15">Destination</h4>
            </div>
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        <li> <a class="icon-home" href="{{ route('admin.index') }}">Dashboard</a></li>
                        <li><span>Destinations List</span></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="box-heading-right"> <a class="btn btn-brand-secondary" href="{{ route('destination.create') }}">
            ...
            <div class="table-responsive">
                <table class="table table-stripped table-mybooking table-responsive">
                    <thead>
                        <tr>
                            {{-- <th class="mw-76"></th> --}}
                            <th class="mw-145"><span class="sort">Title</span></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="card-tour">
                                        ...
                                        <a class="text-md-bold neutral-1000" href="#">{{ $destination->title }}</a>
                                    </div>
                                </td>
                                <td>
                                    <span class="text-md-medium neutral-500">{{ $destination->created_at }}</span>
                                </td>
                                <td class="text-center">
                                    <a class="btn btn-primary" href="{{ route('destinations.show', $destination->slug) }}"
                                        style="padding: 2px 5px; font-size: 12px;">View</a>
                                    <a class="btn btn-secondary" href="{{ route('destination.edit', $destination->id) }} "
    ...
    @if ($destinations->hasPages())
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{ $destinations->previousPageUrl() }}" aria-label="@lang('pagination.previous')">
                ...
                {{-- Pagination Elements --}}
                @foreach ($destinations->links()->elements as $element)
                ...
                @if ($destinations->hasMorePages())
                    <li class="page-item">
                        <a class="page-link" href="{{ $destinations->nextPageUrl() }}" aria-label="@lang('pagination.next')">
                            <span aria-hidden="true">
                                <svg width="12" height="12" viewbox="0 0 12 12" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
