            ...
            <div class="box-breadcrumb">
                <div class="breadcrumbs">
                    <ul>
                        ...
                        <li><span>Blog posts list</span></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="box-heading-right"> <a class="btn btn-brand-secondary" href="{{ route('post.create') }}">
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td>
                                    <div class="card-tour">
                                        {{-- <a href="#"><img src="{{ asset($post->image) }}" alt="Travilla"></a> --}}
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('post.edit', $post->id) }} "
