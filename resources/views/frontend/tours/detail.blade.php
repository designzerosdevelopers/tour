        ...
        <section class="box-section box-breadcrumb background-body">
            <div class="container">
                <ul class="breadcrumbs">
                    ...
                    <li> <a href="{{ route('tours.index') }}">Tours</a><span class="arrow-right">
                            <svg width="7" height="12" viewbox="0 0 7 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 11L6 6L1 1" stroke="" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                            </svg></span></li>
                    <li> <span class="text-breadcrumb">{{ $tour->title }} </span></li>
                </ul>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="tour-header tour-header-on-top">
                        ...
                        <div class="tour-title-main w-lg-75">
                            <h1 class="color-white">{{ $tour->title }}</h1>
                        </div>
            ...
            <div class="row mt-65">
                <div class="col-lg-8">
                    <div class="box-info-tour">
                        <div class="tour-info-group">
                            ...
                            <div class="info-item">
                                ...
                                <p class="text-lg-bold neutral-1000">{{ $tour->duration }}</p>
                            </div>
                        </div>
                        <div class="tour-info-group">
                            ...
                            <div class="info-item">
                                ...
                                <p class="text-lg-bold neutral-1000"> {{ $tour->no_of_people }} People</p>
                            </div>
                        </div>
                        <div class="tour-info-group">
                            ...
                            <div class="info-item">
                                ...
                                <p class="text-lg-bold neutral-1000">{{ $tour->tour_type }}</p>
                            </div>
                        </div>
                        <div class="tour-info-group">
                            ...
                            <div class="info-item">
                                ...
                                @if (json_decode($tour->languages))
                                    @foreach (json_decode($tour->languages) as $language)
                    ...
                    <div class="box-collapse-expand">
                        ...
                        @if (json_decode($tour->includes)[0] != null || json_decode($tour->excludes)[0] != null)
                            <div class="group-collapse-expand">
                                <button class="btn btn-collapse" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="collapse show" id="collapseIncluded">
                                    <div class="card card-body">
                                        <div class="row">
                                            @if (json_decode($tour->includes)[0] != null)
                                                <!-- Check if includes has data -->
                                                <div class="col-lg-6">
                                            ...
                                            @endif
                                            @if (json_decode($tour->excludes)[0] != null)
                                                <!-- Check if excludes has data -->
                                                <div class="col-lg-6">
                            ...
                            <div class="card p-3 mb-20">
                                <div class="row image-box">
                                    @foreach ($widgets as $widget)
                                        <div class="col-3 {{ $loop->first ? '' : 'pl-0' }}">
                                            <img src="{{ asset($widget->image->path . $widget->image->file) }}"
                                                alt="{{ $widget->image->alt }}" data-title="{{ $widget->title }}"
                                                data-description="{{ $widget->description }}" id="defaultImage"
                                ...
                                <div class="image-details" id="imageDetails">
                                    ...
                                    <div class="details-text" id="detailsText">
                                        <h2 id="imageTitle"></h2>
                                        <p class="lh-sm" id="imageDescription"></p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if (!empty($tour->qna) && count($tour->qna) > 0)
                            <div class="group-collapse-expand">
                                <button class="btn btn-collapse" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="collapse show" id="collapseQuestion">
                                    <div class="card card-body">
                                        <div class="list-questions">
                                            @foreach ($tour->qna as $index => $item)
                ...
                <div class="col-lg-4">
                    <form id="bookingForm" action="{{ route('payments.store') }}" method="post" class="booking-form">
                        ...
                        <div class="content-booking-form">
                            ...
                            <div class="item-line-booking">
                                <div class="box-tickets"><strong class="text-md-bold neutral-1000">Tickets (Sharing):</strong>
                                    <div class="line-booking-tickets"
                                        style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                        <div class="item-ticket">
                                            <p class="text-md-medium neutral-500"
                                                style="margin-right: 10px; white-space: nowrap;">Adult (8+ years)</p>
                                            <p class="text-md-medium neutral-500" style=" white-space: nowrap;"
                                                id="adult-price" data-price="{{ $tour->adult_price }}">
                                                {{ $tour->adult_price }} {{ session('currency', 'AED') }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="line-booking-tickets"
                                        ...
                                        <div class="item-ticket">
                                            <p class="text-md-medium neutral-500"
                                                style="margin-right: 10px; white-space: nowrap;">Child (3-8 years)</p>
                                                    <p class="text-md-medium neutral-500" style="white-space: nowrap;"
                                                        id="child-price" data-price="{{ $tour->child_price }}">
                                                        {{ $tour->child_price }} {{ session('currency', 'AED') }}
                                                    </p>
                                        </div>
                            ...
                            <div class="item-line-booking">
                                <div class="box-tickets"><strong class="text-md-bold neutral-1000">Private Tour:</strong>
                                   <span class="info-icon" onclick="showInfo()">i</span>
                                      <div id="info-box" class="info-box">
                                        For private tour please check the below option and the amount will be added to the total
                                      </div> 
                                    <div class="line-booking-tickets">
                                        <div class="item-ticket">
                                            <ul class="list-filter-checkbox">
                                                <li>
                                                    <label class="cb-container">
                                                        ...
                                                        <span class="text-sm-medium">Extra Price for Private Tour
                                                        </span>
                                        ...
                                        <div class="include-price">
                                            <p class="text-md-bold neutral-1000">
                                                {{ $tour->private_transport_extra_cost }}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function setDefaultImage() {
                detailsImage.src = defaultImage.src;
                imageTitle.textContent = defaultImage.getAttribute('data-title');
                imageDescription.textContent = defaultImage.getAttribute('data-description');
            }
            ...
            images.forEach(image => {
                image.addEventListener('mouseover', () => {
                    ...
                    imageTitle.textContent = image.getAttribute('data-title');
        ...
        $(document).ready(function() {
            const timeSlotsArray = @json(json_decode($tour->public_tour_timings));
        ...
        $(document).ready(function() {
            function calculateTotal() {
                var adultPrice = parseFloat("{{ $tour->adult_price }}");
                var childPrice = parseFloat("{{ $tour->child_price }}");
                var privateTransportCost = parseFloat("{{ $tour->private_transport_extra_cost }}");
