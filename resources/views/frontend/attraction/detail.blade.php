...
@section('content')
    <main class="main">
        <section class="box-section box-breadcrumb background-body">
            <div class="container">
                <ul class="breadcrumbs">
                    ...
                    <li> <a href="{{ route('attractions.index') }}">Attractions</a><span class="arrow-right">
                            <svg width="7" height="12" viewbox="0 0 7 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 11L6 6L1 1" stroke="" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                            </svg></span></li>
                    <li> <span class="text-breadcrumb">{{ $attraction->title }} </span></li>
                </ul>
            </div>
        </section>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="box-banner-tour-4"><img
                                            ...
                                            alt="{{ $attraction->images->first()->alt }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="tour-header tour-header-on-top">
                        <div class="tour-title-main w-lg-75">
                            <h1 class="color-white">{{ $attraction->title }}</h1>
                        </div>
                                ...
                                <p class="text-md-medium color-white mr-20 tour-location">
                                    <svg width="12" height="16" viewbox="0 0 12 16" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill=""></path>
                                    </svg> {{ optional($attraction->country)->name }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        @if ($attraction->tours->isNotEmpty() || $attraction->activities->isNotEmpty())
                                                        ...
                                                        <div class="card-program">
                                                            ...
                                                            <div class="endtime">
                                                                <div class="card-price">
                                                                    <h6 class="heading-2 neutral-1000">
                                                                        {{ $tour->adult_price }}
                                            ...
                                            <a href="">
                                                <div class="card-journey-small background-card">
                                                    ...
                                                    <div class="card-info background-card">
                                                        ...
                                                        <div class="card-title"> <a class="text-lg-bold neutral-1000"
                                                                href="{{ route('activities.show', $activity->slug) }}">{{ $activity->title }}
                                                            </a></div>
                                                        <div class="card-program">
                                                            <div class="card-duration-tour">
                                                                <p class="icon-duration text-sm-medium neutral-500">
                ...
                <div class="row mt-65">
                    <div class="col-lg-12">
                        <div class="box-collapse-expand">
                            ...
                            @if (!empty($attraction->qna) && count($attraction->qna) > 0)
                                <div class="group-collapse-expand">
                                    <button class="btn btn-collapse" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="collapse show" id="collapseQuestion">
                                        <div class="card card-body">
                                            <div class="list-questions">
                                                @foreach ($attraction->qna as $index => $item)
