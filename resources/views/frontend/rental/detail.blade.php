...
@section('content')
                        ...
                        <div class="col-lg-4">
                            <form id="bookingForm" action="{{ route('payments.store') }}" method="post"
                                ...
                                <div class="content-booking-form">
                                    ...
                                    <div class="item-line-booking">
                                        <strong class="text-md-bold neutral-1000">
                                    ...
                                    <div class="item-line-booking"> <strong class="text-md-bold neutral-1000">Pickup<span
                                                class="text-danger">*</span></strong>
                                        <div class="line-booking-right">
                                            <input class="form-control" type="text" name="pickup" value=""
                                    ...
                                    <div class="item-line-booking"> <strong
                                            class="text-md-bold neutral-1000">Drop-off<span
                                                class="text-danger">*</span></strong>
                                        <div class="line-booking-right">
                                            <input class="form-control" type="text" name="dropoff" value=""
                                                placeholder="Location">
                                            @error('dropoff')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="item-line-booking"> <strong
                                            class="text-md-bold neutral-1000">Passengers<span
                                                class="text-danger">*</span></strong>
                                        <div class="line-booking-right">
                                            <input class="form-control" type="number" name="passengers" value=""
                                    ...
                                    <div class="item-line-booking"> <strong
                                            class="text-md-bold neutral-1000">Remarks</strong>
                                        <div class="line-booking-right">
                                            <textarea class="form-control" type="number" name="remarks" value="" placeholder="Additional info"></textarea>
                                            @error('remarks')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
    ...
    <script>
        ...
        $('#cust_btn').on('click', function(e) {
            ...
            var passengers = $('input[name="passengers"]').val();
            ...
            if (pickup === '') {
                isValid = false;
                $('input[name="pickup"]').after('<p class="error text-danger">Pickup field is required</p>');
            }
            if (dropoff === '') {
                isValid = false;
                $('input[name="dropoff"]').after('<p class="error text-danger">Drop-off field is required</p>');
            }
            if (passengers === '') {
                isValid = false;
                $('input[name="passengers"]').after(
                    '<p class="error text-danger">Pessangers count is required</p>');
            }
