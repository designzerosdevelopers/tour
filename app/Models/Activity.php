...
class Activity extends Model
{
    ...
    {
        return $this->hasManyThrough(Image::class, ActivityImage::class, 'activity_id', 'id', 'id', 'image_id');
    }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (is_null($model->public_activity_timings)) {
                $model->public_activity_timings = json_encode([]);
            }
